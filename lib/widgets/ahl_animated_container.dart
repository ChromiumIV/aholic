...
class _AhlAnimatedContainerState extends State<AhlAnimatedContainer> {
  ...
  Widget build(BuildContext context) {
    return Listener(
      ...
      onPointerUp: (ev) {
        if (_pointerPosition?.dx != ev.position.dx ||
            _pointerPosition?.dy != ev.position.dy) {
      ...
      child: GestureDetector(
        ...
        // onVerticalDragUpdate: (_) => setState(() => _isPressed = false),
        // onHorizontalDragUpdate: (_) => setState(() => _isPressed = false),
